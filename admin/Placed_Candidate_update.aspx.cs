        ...
        switch (e.CommandName.Trim())
        {
            ...
            case "Delete1":
                ...
                try
                {
                    ...
                    dr = m.ExecuteReader();
                    dr.Read();
                    System.IO.File.Delete("D:\\webserver\\suvidhajobs.in\\www\\placement\\picture\\" + dr[0].ToString());
                    System.IO.File.Delete("D:\\webserver\\suvidhajobs.in\\www\\admin\\picture\\" + dr[0].ToString());
                    dr.Close();
