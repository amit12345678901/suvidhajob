...
public partial class AboutUs_Edit : System.Web.UI.Page
{
    ...
    protected void First_Click(object sender, EventArgs e)
    {
        ...
        m.CommandText = "update About_Us set Subject='" + TextBox1.Text + "'  where ID=1";
        m.ExecuteNonQuery();
        c.Close();
    ...
    protected void Second_Click(object sender, EventArgs e)
    {
       ...
       // Editor1.Content = Replace(Editor1.Content, "'", "''");
        m.CommandText = "update About_Us set Subject='" + Editor1.Content + "'  where ID=2";
        m.ExecuteNonQuery();
        c.Close();
        Label1.Text = "update successfully.";
    }
