                ...
                if (TextBox2.Text== TextBox70.Text.ToString().Trim().Replace("'", "''"))
                {
                    ...
                    else
                    {
                        ...
                        if (!lst1.Contains("Select"))
                        {
                            ...
                            m.Parameters.AddWithValue("@communic", communication.SelectedValue);
                            m.Parameters.AddWithValue("@presentation", presentation.SelectedValue);
                            m.Parameters.AddWithValue("@relevent", relivent_exp.SelectedValue);
                            m.Parameters.AddWithValue("@remarks", remarks.Text);
                            m.Parameters.AddWithValue("@rsposted", rsposted_by.SelectedValue);
                            m.Parameters.AddWithValue("@source", source.SelectedValue);
...
Label3.Text = "";
    ...
    public void mail(string to, string name, string uid, string pass)
    {
        ...
        msgMail.Subject = "Welcome To suvidhajobs.in";
        ...
        msgMail.Body = "<html><body><br><br><table border=1 cellpadding=5 cellspacing=0 bordercolor=#CCCCCC>"+
                     ...
                     " </tr> <tr><td>        Dear"+ name+" , <br><p align=justify>Thank you for registering with Suvidhajobs.</p>"+
          ...
          "</tr><tr><td></td> </tr><td bgcolor=#f6e2c1>For any Queries e-mail us at ,response@suvidhajobs.in</td>" +
          "</tr>  <tr><td></td></tr><tr><td>We look forward to a long and fruitful association with you. <br><br>With regards.<br> Team suvidhajobs.in</td>" +
