...
public partial class Course : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                c.Open();
                m.Connection = c;
                m.CommandText = "select  Subject  from  Course where ID=1";
                ...
                m.CommandText = "select  Subject  from Course where ID=2";
                dr1 = m.ExecuteReader();
                dr1.Read();
    ...
    protected void First_Click(object sender, EventArgs e)
    {
        ...
        m.CommandText = "update Course set Subject='" + TextBox1.Text + "'  where ID=1";
        m.ExecuteNonQuery();
        c.Close();
    ...
    protected void Second_Click(object sender, EventArgs e)
    {
       ...
       // Editor1.Content = Replace(Editor1.Content, "'", "''");
        m.CommandText = "update Course set Subject='" + Editor1.Content + "'  where ID=2";
        m.ExecuteNonQuery();
        c.Close();
        Label1.Text = "update successfully.";
    }
