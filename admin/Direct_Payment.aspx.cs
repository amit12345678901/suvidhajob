...
public partial class admin_Direct_Payment : System.Web.UI.Page
{
    ...
    public void bind()
    {
        try
        {
            ...
            dt = g1.return_dt("select order_master.order_id,order_master.user_id,order_master.order_date,order_master.bill_no as [Bill Number],order_master.name,order_master.email,order_master.bill_tel as Telephone,order_master.Payment,order_master.address1 as [Address],order_master.full_payment as [Amount],order_master.paym_id as [Payment Id],order_master.tran_id as [Transaction Id],order_master.result as [Result],order_master.ref_no as [Reference No],order_master.error_txt as [Error]  from order_master where user_id=0  order by order_id desc");
