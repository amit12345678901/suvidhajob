...
public partial class Current_Opening_Informetion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            try
            {
                ...
                m.CommandText = "select cname_txt as [Company  Name],cprofile_txt as [Company Profile],jp_txt as [Job Position],jobr_txt as [Job Responsibility],year_min_txt as [Minimun Expperience (Year)],year_max_txt as [Maximum Experience  (Year)],aqr_txt as [Academic Qualification],pqr_txt as [Professional Qualification],loc_txt as Location,in_txt as Industry,fa_txt  as [Functional Area],sfa_txt  as [Sub Functional Area],salary_txt as [Minimum Salary  (Lakh  per annum)],salary_txt_max as [Maximum Salary  (Lakh  per annum)],novacc_txt as [Number of Vacancy] from post_vaca  where pv_id_txt=" + id;
        ...
        /*
            ...
            {
                if (DetailsView1.Rows[0].Cells[12].Text == "0")
                {
                    DetailsView1.Rows[0].Cells[12].Text = "Best in Industry.";
                    DetailsView1.Rows[0].Cells[13].Visible = false;
                }
