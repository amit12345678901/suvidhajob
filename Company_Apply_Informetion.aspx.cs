    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                c.Open();
                m.Connection = c;
                m.CommandText = "select pv_id_txt,in_txt as Industry,fa_txt as [Functional Area],loc_txt as Location,post_date as [Post Daate]  from  post_vaca  where cid=" + Session["Client_number"]+"  and hidden_txt=0";
        ...
        switch (e.CommandName.Trim())
        {
            ...
            case "Detail":
                ...
                try
                {
                    ...
                    c.Open();
                    m.Connection = c;
                    m.CommandText = "select id_txt,name_txt  as NAME,in_txt  as  INDUSTRY,aq_txt as [ACADEMIC QUALIFICATION],pq_txt as [PROFESIONAL QUALIFICATIN],exp_txt as EXPERIENCE,ctc_txt  as SALARY,cloc_txt as LOCATION from pyr_master where id_txt in(select can_id  from  apply_master  where pv_id=" + r1+" )";
