...
public partial class Resume_Search_Form : System.Web.UI.Page
{
    ...
    protected void Search_Click(object sender, EventArgs e)
    {
        ...
        if (TextBox1.Text == "" && DropDownList6.SelectedValue.ToString() == "Select" && DropDownList7.SelectedValue.ToString() == "Select"  && DropDownList10.SelectedValue.ToString() == "Select" && TextBox2.Text == "" && TextBox3.Text == "")
        {
