...
public partial class Modifie_Candidate : System.Web.UI.Page
{
            ...
            {
                {
                    try
                    {
                        ...
                        if (dr[14].ToString() != "")
                        {
                            DropDownList5.SelectedValue = dr[14].ToString();
                        }
                        if (dr[15].ToString() != "")
                        {
                            //DropDownList6.SelectedValue = dr[15].ToString();
                        }
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        ...
        if (TextBox3.Text != "" && TextBox6.Text != "" && TextBox7.Text != "" && TextBox8.Text != "")
        {
            ...
            c.Open();
            m.Connection = c;
            m.CommandText = "update pyr_master set name_txt='" + TextBox3.Text + "',sex_txt='" + DropDownList1.SelectedValue + "',date_txt='" + DropDownList2.SelectedValue + "',month_txt='" + DropDownList3.SelectedValue + "',year_txt='" + DropDownList4.SelectedValue + "',email_txt='" + TextBox4.Text + "',add_txt='" + TextBox6.Text + "',cloc_txt='" + TextBox7.Text + "',S_country='" + TextBox8.Text + "',ms_txt='" + DropDownList12.SelectedItem + "',tel_txt='" + TextBox9.Text + "',mob_txt='" + TextBox10.Text + "',aq_txt='" + DropDownList5.SelectedValue + "',pq_txt='" + DropDownList6.SelectedItem + "',aqo_txt='" + TextBox12.Text + "',pqo_txt='" + TextBox13.Text + "',ins_txt='" + TextBox11.Text + "',yq_txt='" + TextBox7.Text + "',res_tit_txt='" + TextBox14.Text + "',ks_txt='" + TextBox15.Text + "',exp_txt=" + Int32.Parse(TextBox16.Text) + ",in_txt='" + ListBox1.SelectedValue + "',t_n='" + DropDownList8.SelectedValue + "',f_n='" + DropDownList13.SelectedValue + "',curr_emp_txt='" + TextBox17.Text + "',curr_emp_from_txt='" + TextBox40.Text + "',curr_emp_to_txt='" + TextBox41.Text + "',curr_des_txt='" + TextBox18.Text + "',job_res_txt='" + TextBox19.Text + "',pre_emp_txt='" + TextBox39.Text + "',pre_emp_from_txt='" + TextBox37.Text + "',pre_emp_to_txt='" + TextBox38.Text + "',pre_des_txt='" + TextBox21.Text + "',ljob_res_txt='" + TextBox43.Text + "',pre_emp_txt2='" + TextBox36.Text + "',pre_emp_from_txt2='" + TextBox34.Text + "',pre_emp_to_txt2='" + TextBox35.Text + "',pre_des_txt2='" + TextBox23.Text + "',ljob_res_txt2='" + TextBox44.Text + "',pre_emp_txt3='" + TextBox24.Text + "',pre_emp_from_txt3='" + TextBox32.Text + "',pre_emp_to_txt3='" + TextBox33.Text + "',pre_des_txt3='" + TextBox25.Text + "',ljob_res_txt3='" + TextBox26.Text + "',ctc_txt=" + TextBox27.Text + ",summery_txt='" + TextBox28.Text + "',lan1_txt='" + TextBox29.Text + "',lan2_txt='" + TextBox30.Text + "',lan3_txt='" + TextBox31.Text + "',lan1_r_txt='" + ch1 + "',lan1_w_txt='" + ch2 + "',lan1_s_txt='" + ch3 + "', lan2_r_txt='" + ch4 + "',lan2_w_txt='" + ch5 + "',lan2_s_txt='" + ch6 + "', lan3_r_txt='" + ch7 + "',lan3_w_txt='" + ch8 + "',lan3_s_txt='" + ch9 + "',jt_txt='" + DropDownList9.SelectedValue + "',es_txt='" + DropDownList10.SelectedValue + "',pre_txt='" + DropDownList11.SelectedValue + "',ref_n_txt='" + TextBox45.Text + "',ref_d_txt='" + TextBox46.Text + "',ref_phone_txt='" + TextBox47.Text + "',ref_co_txt='" + TextBox48.Text + "',ref_rr_txt='" + TextBox49.Text + "',ref_email_txt='" + TextBox50.Text + "'  where user_txt='" + TextBox2.Text + "'";
