...
public partial class Viewprofile_Form : System.Web.UI.Page
{
    ...
    public string[] arr = new string[42];
    ...
    {
        dt = g1.return_dt("SELECT name_txt,File_Data FROM pyr_master WHERE id_txt=" + Session["can_id"]);
