...
public partial class update_cv : System.Web.UI.Page
{
    ...
    public void bind()
    {
        ...
        try
        {
            ...
            m.CommandText = "select  File_Data,File_Name from  pyr_master where user_txt='" + Session["user_txt"] + "'";
            SqlDataReader dr1;
            dr1 = m.ExecuteReader();
            dr1.Read();
            if (dr1[0].ToString() == "" || dr1[1].ToString() == "no")
            {
                dr1.Close();
                Label1.Text = "CV is not Available.";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
            ...
            switch (exten.ToLower())
            {
                ...
                case ".rtf":
                    ...
                    try
                    {
                        ...
                        c.Open();
                        m.Connection = c;
                        m.CommandText = "update  pyr_master set File_Data=@File_Data,File_Size=@File_Size,File_Name='yes'  where user_txt='" + Session["user_txt"] + "'";
                        m.Parameters.AddWithValue("@File_Data", data);
                        m.Parameters.AddWithValue("@File_Size", lenght);
                        m.ExecuteNonQuery();
                        c.Close();
                        Label1.Text = "successfully Completed process.";
                        bind();
                    }
                    catch (Exception ex)
                    {
        ...
        {
            Label1.Text = "you first enter file path.";
        }
    }
    ...
    protected void delete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            m.ExecuteNonQuery();
            Response.Redirect("Edit_Candidate.aspx");
        }
        catch (Exception ex)
        {
            Label1.Text = ex.ToString();
    ...
    protected void view_Click(object sender, EventArgs e)
    {
       ...
       //view= "D:\\webserver\\ackgroup.in\\www\\placement\\cv\\" + name;
    }
}
