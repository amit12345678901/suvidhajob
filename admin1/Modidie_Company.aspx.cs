   ...
   int remcount=0;
    ...
    public void bind()
    {
        try
        {
            ...
            m.CommandText = "select co_name_txt2,Username_txt,password_txt,id_txt,branch_txt,DrCity1,add_txt2,email_txt,t_n2,t_n_o2,phone2,mobile2,website2,c_point_txt2,desi_txt2,size_txt2,branches_txt2,empl_txt2,auth_txt,rs_auth,jp_auth,dev_by,end_date  from clogin_detail where id_txt=" + Int32.Parse(Session["com_id"].ToString());
            SqlDataReader dr;
            dr = m.ExecuteReader();
            dr.Read();
           ...
           // terms.Text = dr[18].ToString();
            ...
            //e_date.Text = dr[20].ToString();
               ...
               if (dr[22].ToString() != "")
               {
                   stdate.SelectedDate = Convert.ToDateTime(dr[22].ToString());
                   lbstdate.Text = stdate.SelectedDate.ToLongDateString();
               }
               else
               {
                   stdate.SelectedDate = DateTime.Now.AddDays(3).Date;
                   lbstdate.Text = stdate.SelectedDate.ToLongDateString();
               }
    ...
    protected void update_Click(object sender, EventArgs e)
    {
         ...
         if (cname.Text != "" && uname.Text != "" && password.Text != "" && city.Text != "" && address.Text != "" && mobile.Text != "")
        {
    ...
    public void bind1()
    {
        int auth = 0, rs = 0, jp = 0,jobrem=0,emailrem=0,smsrem=0,cvrem=0;
        ...
        {
            m.CommandText = "update clogin_detail set co_name_txt2='" + cname.Text + "',username_txt='" + uname.Text + "',password_txt='" + password.Text + "',Client_number='" + c_no.Text + "',branch_txt='" + branch.Text + "',DrCity1='" + city.Text + "',add_txt2='" + address.Text + "',email_txt='" + email.Text + "',t_n2='" + t_n2.Text + "',t_n_o2='" + t_no2.Text + "',phone2='" + phone.Text + "',mobile2='" + mobile.Text + "',website2='" + website.Text + "',c_point_txt2='" + c_profile.Text + "',desi_txt2='" + designation.Text + "',size_txt2='" + size1.Text + "',branches_txt2='" + branches.Text + "',empl_txt2='" + email.Text + "',auth_txt=" + auth + ",rs_auth=" + rs + ",jp_auth=" + jp + ",dev_by='" + dev.Text + "',end_date='" + stdate.SelectedDate.ToShortDateString() + "'  where id_txt=" + Int32.Parse(Session["com_id"].ToString());
            m.ExecuteNonQuery();
