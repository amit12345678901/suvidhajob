...
public partial class Resume_Search_Informetion : System.Web.UI.Page
{
    ...
    public void bind1()
    {
        try
        {
            ...
            {
                key = "(in_txt='" + Request.Cookies["t1"].Value + "' or t_n='" + Request.Cookies["t1"].Value + "' or t_no_txt='" + Request.Cookies["t1"].Value + "' or f_n='" + Request.Cookies["t1"].Value + "' or ks_txt='" + Request.Cookies["t1"].Value + "' or aq_txt='" + Request.Cookies["t1"].Value + "' or pq_txt='" + Request.Cookies["t1"].Value + "') and ";
            }
          ...
          //  m.CommandText = "select id_txt,name_txt  as NAME,in_txt  as  INDUSTRY,aq_txt as [ACADEMIC QUALIFICATION],pq_txt as [PROFESIONAL_QUALIFICATIN],exp_txt as EXPERIENCE,ctc_txt  as SALARY,cloc_txt as LOCATION from pyr_master  where  Status_txt=0 and  " + key + s + fn + fa + m1 + a + p + " exp_txt>=" + min_exp + " and exp_txt<=" + max_exp + " and ctc_txt>=" + min_ctc + " and ctc_txt<=" + max_ctc + emp + des;
           
            
           dt = g1.return_dt("select id_txt,name_txt  as NAME,in_txt  as  INDUSTRY,aq_txt as [ACADEMIC QUALIFICATION],pq_txt as [PROFESIONAL_QUALIFICATIN],exp_txt as EXPERIENCE,ctc_txt  as SALARY,cloc_txt as LOCATION from pyr_master  where  Status_txt=0 and  " + key + s + fn + fa + m1 + a + p + " exp_txt>=" + min_exp + " and exp_txt<=" + max_exp  + emp + des);
