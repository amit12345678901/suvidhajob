    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
             c.ConnectionString = ConfigurationManager.ConnectionStrings["mycon"].ToString();
              ...
              m.CommandText = "select cname_txt as [Company  Name],cprofile_txt as [Company Profile],jp_txt as [Job Position],jobr_txt as [Job Responsibility],year_min_txt as [Minimun Expperience],year_max_txt as [Maximum Experience],aqr_txt as [Academic Qualification],pqr_txt as [Prrofisional Qualification],loc_txt as Location,in_txt as Industry,fa_txt  as [Functional Area],sfa_txt  as [Sub Functional Area],salary_txt as Salary,keywords_txt as Keyword,novacc_txt as [Number of Vacancy],jobcode_txt as [Job Code] from post_vaca  where pv_id_txt=" + Int32.Parse(Session["pv_id"].ToString());
